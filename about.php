      ...
      <article>    
        ...
        <section class="section background-white">
          <div class="line text-center">
            <i class="icon-sli-question text-primary text-size-40"></i>
          ...
          <div class="line">
            <div class="margin2x">
              ...
              <div class="m-12 l-6">
                ...
                <p class="animated-element slow margin-bottom-30">SH Aviation is an independent Malawi owned company. We provide platinum first class services in Aviation industry by providing excellent flight support services to customers with professionalism.
                </p>
                              
                <h3 class="animated-element text-strong text-size-20 text-line-height-1 margin-bottom-20">Our Vision</h3>
                <p class="animated-element slow margin-bottom-30">To become a platinum and first class leader in Aviation Industry by providing excellent flight support services to customers with professionalism.
                </p>
                <h3 class="animated-element text-strong text-size-20 text-line-height-1 margin-bottom-20">Our Slogan</h3>
                <p class="animated-element slow margin-bottom-30">Enjoy the height as we take care of the ground works.
                </p>
              </div>
